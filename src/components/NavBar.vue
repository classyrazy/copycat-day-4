<template>
 <header class="bg-white">
    ...
    <div class="sticky transition bg-white top-0 right-0 left-0 py-4 sticky_container z-[100]">
        <div class="container mx-auto flex  justify-between items-center">
            <h3 class="font-medium text-xl">Horizontal Mashup Copycat</h3>
            <nav>
                <ul class="flex items-center gap-10 text-sm">
                    <li>Overview</li>
                    <li>Tech Specs</li>
                    <button type="button" class="bg-[#0171e2] px-4 py-1.5 rounded-full text-white text-sm">Buy Now</button>
                </ul>
            </nav>
        </div>
    </div>
